package com.example.fcmnotificationbg;
...
public class MyFirebaseService extends FirebaseMessagingService {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void simpleNotification(String messageTitle, String messageBody) {
        ...
        builder = new NotificationCompat.Builder(getBaseContext(), channel.getId())
        ...
        Person jd = new Person.Builder()
                .setName(messageTitle)
                .setImportant(true)
                .build();

        new NotificationCompat.MessagingStyle(jd)
                .addMessage(messageBody, new Date().getTime(), jd)
                .setBuilder(builder);
